  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-cream-50 to-marigold-50 p-8">
      <div className="max-w-4xl mx-auto">
        <h1 className="text-4xl font-bold text-kerala-green-800 mb-4">Temple Traditions</h1>
        <p className="text-lg text-gray-700 mb-8">This is a placeholder for the 18 lessons on Kerala's temple traditions. The lessons will cover ancient customs and religious vocabulary.</p>
