...
export default function FillInTheBlanksPage() {
  ...
  const currentGameId = 'fill-in-the-blanks';
      ...
      {gameCompleted ? (
        <div className="text-center p-8 bg-white rounded-lg shadow-xl">
          ...
          <p className="text-xl text-gray-700 mb-6">
            {wasSuccessful ? "You've passed the Fill in the Blanks game!" : "Better luck next time!"}
          </p>
          <Button 
        ...
        <>
          <h1 className="text-4xl font-bold text-kerala-green-800 mb-8">Fill in the Blanks</h1>
          <FillInTheBlanksGame onComplete={handleGameComplete} />
        </>
      )}
    </div>
  );
