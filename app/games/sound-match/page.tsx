...
export default function SoundMatchPage() {
  ...
  const currentGameId = 'sound-match';
      ...
      {gameCompleted ? (
        <div className="text-center p-8 bg-white rounded-lg shadow-xl">
          ...
          <p className="text-xl text-gray-700 mb-6">
            {wasSuccessful ? "You've passed the Sound Match game!" : "Better luck next time!"}
          </p>
          <Button 
        ...
        <>
          <h1 className="text-4xl font-bold text-kerala-green-800 mb-8">Sound Match</h1>
          <SoundMatchGame onComplete={handleGameComplete} />
        </>
      )}
    </div>
  );
