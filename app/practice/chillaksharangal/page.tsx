...
import { practiceChillaksharangal } from '@/lib/practice-data';
import { shuffle } from '@/lib/utils';

const MODULE_ID = 'chillaksharangal-practice';

export default function ChillaksharangalPracticePage() {
  const router = useRouter();
  const { updateModuleProgress, resetModuleProgress } = useProgress();
  ...
  useEffect(() => {
    if (shuffledQuestions.length === 0) {
      setShuffledQuestions(shuffle([...practiceChillaksharangal]));
    }
  ...
  const handleRestart = () => {
    ...
    setShuffledQuestions(shuffle([...practiceChillaksharangal])); // Reshuffle questions
  ...
  return (
    <div className="text-center">
      ...
      <div className="mt-8">
        <a href="mailto:developersunilb@gmail.com?subject=Feedback on Chillaksharangal Practice">
