...
export default function KootaksharangalPracticePage() {
  ...
  useEffect(() => {
    setShuffledQuestions(shuffle([...practiceKootaksharangal]));
  ...
  const handleRestart = () => {
    ...
    setShuffledQuestions(shuffle([...practiceKootaksharangal])); // Reshuffle questions
  ...
  return (
    <div className="text-center">
      ...
      <div className="mt-8">
        <a href="mailto:developersunilb@gmail.com?subject=Feedback on Kootaksharangal Practice">
