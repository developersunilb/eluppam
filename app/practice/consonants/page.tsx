...
export default function ConsonantsPracticePage() {
  ...
  useEffect(() => {
    setShuffledQuestions(shuffle([...practiceConsonants]));
  ...
  const handleRestart = () => {
    ...
    setShuffledQuestions(shuffle([...practiceConsonants])); // Reshuffle questions
  ...
  return (
    <div className="text-center">
      ...
      <div className="mt-8">
        <a href="mailto:developersunilb@gmail.com?subject=Feedback on Consonants Practice">
